                ...
                <div class="form login">
                    ...
                    <form action="#">
                        ...
                        <div class="checkbox-text">
                            ...
                            <a href="forgot_pass.html" class="text">Forgot Password</a>

                        </div>

                        <div class="input-field button">
                            <a href="./seller_list.html"><input type="button" value="Login"></a>
                        </div>
                    </form>
                    ...
                    <a href="../main/landing.html" class="back">Go To Home</a>
                </div>
                <!--Registration Form-->
