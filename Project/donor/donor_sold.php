    ...
    <div class="nav">
        <div class="menu" id="menu">
            <ul>
                ...
                <li><a href="donor_sold.html" id="active"><i class="fa fa-handshake-o "></i><span>Donated Items</span></a></li>
                <li><a href="donor_add.html" ><i class="fa fa-plus-square "></i><span>Add Items</span></a></li>
