...
if (isset($_POST['submit'])) {
    ...
    $select = " SELECT * FROM dlogin WHERE username = '$username' && password = '$pass' ";
    ...
    if (mysqli_num_rows($result) > 0) {
        ...
        if ($pass != $cpass) {
            ...
            $insert = "INSERT INTO dlogin(username, password, fname, lname, mail, number, aadhar)  VALUES('$username','$pass','$fname','$lname','$email','$number','$aadhar')";
...
<head>
    ...
    <link rel="stylesheet" href="donor_registration.css">
</head>
            ...
            <div class="form signup">
                ...
                <div class="login-signup">
                    <span class="text">Already registerd?
                        <a href="donor_login.php" class="text login-link">Login Now</a>
                    </span>
                </div>
