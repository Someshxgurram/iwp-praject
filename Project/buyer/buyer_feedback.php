    ...
    <div class="nav">
        <div class="menu" id="menu">
            <ul>
                ...
                <li><a href="buyer_purchase.html"><i class="fa fa-cart-arrow-down "></i><span>Previous Purchases</span></a></li>
                <li><a href="buyer_feedback.html" id="active"><i class="fa fa-comments "></i><span>Feedback</span></a></li>
