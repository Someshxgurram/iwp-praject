...
if (isset($_POST['submit'])) {
    ...
    $select = " SELECT * FROM blogin WHERE username = '$username' && password = '$pass' ";
    ...
    if (mysqli_num_rows($result) > 0) {
        ...
        if ($pass != $cpass) {
            ...
            $insert = "INSERT INTO blogin(username, password, fname, lname, email, number, aadhar, wallet)  VALUES('$username','$pass','$fname','$lname','$email','$number','$aadhar',$wallet)";
...
<head>
    ...
    <link rel="stylesheet" href="buyer_registration.css">
</head>
            ...
            <div class="form signup">
                ...
                <div class="login-signup">
                    <span class="text">Already registerd?
                        <a href="buyer_login.php" class="text login-link">Login Now</a>
                    </span>
                </div>
