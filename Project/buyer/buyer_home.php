...
<body>
    ...
    <div class="nav">
        <div class="menu" id="menu">
            <ul>
                <li><a href="buyer_home.html" id="active"><i class="fa fa-home "></i><span>Home</span></a></li>
                <li><a href="buyer_account.html"><i class="fa fa-user-circle "></i><span>View Account</span></a></li>
                <li><a href="buyer_purchase.html" ><i class="fa fa-cart-arrow-down "></i><span>Previos Purchases</span></a></li>
